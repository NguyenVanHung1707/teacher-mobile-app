import { FlatList, Text, View, TouchableOpacity, StyleSheet, Alert, ActivityIndicator } from 'react-native';
    ...
    <>
      ...
      <View style={styles.activeBar}>
        <View style={styles.buttonRow}>
          ...
          <TouchableOpacity style={[styles.addButton, { flexDirection: 'row', alignItems: 'center' }]} onPress={() => navigation.navigate('ClassDiscussion')}>
            <Icon name="comments" size={16} color="#FFFFFF" style={{ marginRight: 6 }} />
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text style={[styles.tabButtonText, activeTab === 'students' && styles.activeTabButtonText]}>
            Danh sách sinh viên
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          <View style={[styles.studentList]}>
            {isAssessmentsLoading ? (
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyText}>Chưa có bài thi hoặc bài tập nào trong lớp học này.</Text>
              </View>
            ) : (
              <FlatList
